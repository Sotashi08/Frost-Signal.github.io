...
const CATEGORIES = {
    ...
    "Мебель": [
        "стул","стол","кровать","шкаф","диван","комод","полка","кресло","туалетныйстолик","письменныйстол",
        "книжныйшкаф","табурет","диванчик","тумбочка","банкетка","этажерка","шкафчик","кроватка","сервант","канапе"
    ],
    "Спорт": [
        "футбол","баскетбол","теннис","волейбол","плавание","бег","хоккей","гимнастика","бокс","гольф",
        "регби","сёрфинг","лыжи","сноуборд","фигурное","шахматы","настольныйтеннис","бадминтон","борьба","скейтборд"
    ],
    "Еда": [
